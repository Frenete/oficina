...
class Servico(models.Model):
    ...
    valor= models.DecimalField(verbose_name='Valor RS', max_digits=19, decimal_places=2)
...
class OrdemServico(models.Model):
    ...
    codigo = models.PositiveBigIntegerField(verbose_name='codigo 05', unique=True)
    servico = models.ManyToManyField(Servico, verbose_name='Serviços', related_name='os')

    def __str__(self) -> str:
        return self.Oficina.name
